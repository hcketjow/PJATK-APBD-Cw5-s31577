...
public interface IPatientService
{
    ...
    Task<PatientResponse> CreateAsync(PatientRequest request, CancellationToken cancellationToken);
    Task<PatientResponse?> UpdateAsync(int id, PatientRequest request, CancellationToken cancellationToken);
